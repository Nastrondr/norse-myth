import bgmMainUrl from '../static/audio/bgm-main.mp3'
...
export function initAudio() {
  ...
  // 不能用 'static/...' 相对路径：H5 下会基于页面路由（如 /pages/index/）解析导致 404，
  // 通过 import 让构建器生成带正确 base 的资源 URL
  audio.src = bgmMainUrl
  audio.loop = true
